...
POSTGRES_PASSOWRD = os.environ['POSTGRES_PASSOWRD']

app.config['SQLALCHEMY_DATABASE_URI'] = F'postgressql://{POSTGRES_USER}:{POSTGRES_PASSOWRD}@{POSTGRES_HOST}:{POSTGRES_PORT}/{POSTGRES_DB}'
...
red = redis.Redis(host=RADIS_HOST, port=RADIS_PORT, db=0)
